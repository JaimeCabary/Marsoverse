...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function Oc(){return new qn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ro(),fragmentShader:`
		...
		`,blending:Xn,depthTest:!1,depthWrite:!1})}function Bc(){return new qn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ro(),fragmentShader:`
	...
	`}function Dm(s){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===fs||c===Ma,h=c===Bi||c===ki;if(l||h){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new Nc(s)),u=l?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const p=o.image;return l&&p&&p.height>0||h&&p&&i(p)?(t===null&&(t=new Nc(s)),u=l?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function i(o){let c=0;const l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function Im(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Ui("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Um(s,e,t,n){const i={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete i[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return i[d.id]===!0||(d.addEventListener("dispose",a),i[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const p in d)e.update(d[p],s.ARRAY_BUFFER)}function l(u){const d=[],p=u.index,g=u.attributes.position;let x=0;if(p!==null){const b=p.array;x=p.version;for(let E=0,S=b.length;E<S;E+=3){const I=b[E+0],L=b[E+1],A=b[E+2];d.push(I,L,L,A,A,I)}}else if(g!==void 0){const b=g.array;x=g.version;for(let E=0,S=b.length/3-1;E<S;E+=3){const I=E+0,L=E+1,A=E+2;d.push(I,L,L,A,A,I)}}else return;const m=new(Pl(d)?Nl:Ul)(d,1);m.version=x;const f=r.get(u);f&&e.remove(f),r.set(u,m)}function h(u){const d=r.get(u);if(d){const p=u.index;p!==null&&d.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function Nm(s,e,t){let n;function i(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function c(d,p){s.drawElements(n,p,r,d*a),t.update(p,n,1)}function l(d,p,g){g!==0&&(s.drawElementsInstanced(n,p,r,d*a,g),t.update(p,n,g))}function h(d,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,n,1)}function u(d,p,g,x){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)l(d[f]/a,p[f],x[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,x,0,g);let f=0;for(let b=0;b<g;b++)f+=p[b]*x[b];t.update(f,n,1)}}this.setMode=i,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Fm(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case s.TRIANGLES:t.triangles+=o*(r/3);break;case s.LINES:t.lines+=o*(r/2);break;case s.LINE_STRIP:t.lines+=o*(r-1);break;case s.LINE_LOOP:t.lines+=o*r;break;case s.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Om(s,e,t){const n=new WeakMap,i=new Ze;function r(a,o,c){const l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let v=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",v)};var p=v;d!==void 0&&d.texture.dispose();const g=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],b=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let S=0;g===!0&&(S=1),x===!0&&(S=2),m===!0&&(S=3);let I=o.attributes.position.count*S,L=1;I>e.maxTextureSize&&(L=Math.ceil(I/e.maxTextureSize),I=e.maxTextureSize);const A=new Float32Array(I*L*4*u),R=new Ll(A,I,L,u);R.type=Nt,R.needsUpdate=!0;const y=S*4;for(let w=0;w<u;w++){const V=f[w],F=b[w],z=E[w],X=I*L*4*w;for(let H=0;H<V.count;H++){const K=H*y;g===!0&&(i.fromBufferAttribute(V,H),A[X+K+0]=i.x,A[X+K+1]=i.y,A[X+K+2]=i.z,A[X+K+3]=0),x===!0&&(i.fromBufferAttribute(F,H),A[X+K+4]=i.x,A[X+K+5]=i.y,A[X+K+6]=i.z,A[X+K+7]=0),m===!0&&(i.fromBufferAttribute(z,H),A[X+K+8]=i.x,A[X+K+9]=i.y,A[X+K+10]=i.z,A[X+K+11]=z.itemSize===4?i.w:1)}}d={count:u,texture:R,size:new Pe(I,L)},n.set(o,d),o.addEventListener("dispose",v)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",a.morphTexture,t);else{let g=0;for(let m=0;m<l.length;m++)g+=l[m];const x=o.morphTargetsRelative?1:1-g;c.getUniforms().setValue(s,"morphTargetBaseInfluence",x),c.getUniforms().setValue(s,"morphTargetInfluences",l)}c.getUniforms().setValue(s,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(s,"morphTargetsTextureSize",d.size)}return{update:r}}function Bm(s,e,t,n){let i=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),i.get(c)!==l&&(t.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;i.get(d)!==l&&(d.update(),i.set(d,l))}return u}function a(){i=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}const Yl=new _t,kc=new Vl(1,1),ql=new Ll,jl=new Eu,Kl=new Bl,zc=[],Hc=[],Vc=new Float32Array(16),Gc=new Float32Array(9),Wc=new Float32Array(4);function ji(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=zc[i];if(r===void 0&&(r=new Float32Array(i),zc[i]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,s[a].toArray(r,o)}return r}function xt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function vt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function Mr(s,e){let t=Hc[e];t===void 0&&(t=new Int32Array(e),Hc[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function km(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function zm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;s.uniform2fv(this.addr,e),vt(t,e)}}function Hm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(xt(t,e))return;s.uniform3fv(this.addr,e),vt(t,e)}}function Vm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;s.uniform4fv(this.addr,e),vt(t,e)}}function Gm(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;Wc.set(n),s.uniformMatrix2fv(this.addr,!1,Wc),vt(t,n)}}function Wm(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;Gc.set(n),s.uniformMatrix3fv(this.addr,!1,Gc),vt(t,n)}}function Xm(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),vt(t,e)}else{if(xt(t,n))return;Vc.set(n),s.uniformMatrix4fv(this.addr,!1,Vc),vt(t,n)}}function Ym(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function qm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;s.uniform2iv(this.addr,e),vt(t,e)}}function jm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;s.uniform3iv(this.addr,e),vt(t,e)}}function Km(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;s.uniform4iv(this.addr,e),vt(t,e)}}function Zm(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function $m(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;s.uniform2uiv(this.addr,e),vt(t,e)}}function Jm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;s.uniform3uiv(this.addr,e),vt(t,e)}}function Qm(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;s.uniform4uiv(this.addr,e),vt(t,e)}}function eg(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(kc.compareFunction=Rl,r=kc):r=Yl,t.setTexture2D(e||r,i)}function tg(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||jl,i)}function ng(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Kl,i)}function ig(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||ql,i)}function sg(s){switch(s){case 5126:return km;case 35664:return zm;case 35665:return Hm;case 35666:return Vm;case 35674:return Gm;case 35675:return Wm;case 35676:return Xm;case 5124:case 35670:return Ym;case 35667:case 35671:return qm;case 35668:case 35672:return jm;case 35669:case 35673:return Km;case 5125:return Zm;case 36294:return $m;case 36295:return Jm;case 36296:return Qm;case 35678:case 36198:case 36298:case 36306:case 35682:return eg;case 35679:case 36299:case 36307:return tg;case 35680:case 36300:case 36308:case 36293:return ng;case 36289:case 36303:case 36311:case 36292:return ig}}function rg(s,e){s.uniform1fv(this.addr,e)}function ag(s,e){const t=ji(e,this.size,2);s.uniform2fv(this.addr,t)}function og(s,e){const t=ji(e,this.size,3);s.uniform3fv(this.addr,t)}function cg(s,e){const t=ji(e,this.size,4);s.uniform4fv(this.addr,t)}function lg(s,e){const t=ji(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function hg(s,e){const t=ji(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function ug(s,e){const t=ji(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function dg(s,e){s.uniform1iv(this.addr,e)}function fg(s,e){s.uniform2iv(this.addr,e)}function pg(s,e){s.uniform3iv(this.addr,e)}function mg(s,e){s.uniform4iv(this.addr,e)}function gg(s,e){s.uniform1uiv(this.addr,e)}function _g(s,e){s.uniform2uiv(this.addr,e)}function xg(s,e){s.uniform3uiv(this.addr,e)}function vg(s,e){s.uniform4uiv(this.addr,e)}function Mg(s,e,t){const n=this.cache,i=e.length,r=Mr(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let a=0;a!==i;++a)t.setTexture2D(e[a]||Yl,r[a])}function yg(s,e,t){const n=this.cache,i=e.length,r=Mr(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let a=0;a!==i;++a)t.setTexture3D(e[a]||jl,r[a])}function Sg(s,e,t){const n=this.cache,i=e.length,r=Mr(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let a=0;a!==i;++a)t.setTextureCube(e[a]||Kl,r[a])}function Eg(s,e,t){const n=this.cache,i=e.length,r=Mr(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let a=0;a!==i;++a)t.setTexture2DArray(e[a]||ql,r[a])}function Tg(s){switch(s){case 5126:return rg;case 35664:return ag;case 35665:return og;case 35666:return cg;case 35674:return lg;case 35675:return hg;case 35676:return ug;case 5124:case 35670:return dg;case 35667:case 35671:return fg;case 35668:case 35672:return pg;case 35669:case 35673:return mg;case 5125:return gg;case 36294:return _g;case 36295:return xg;case 36296:return vg;case 35678:case 36198:case 36298:case 36306:case 35682:return Mg;case 35679:case 36299:case 36307:return yg;case 35680:case 36300:case 36308:case 36293:return Sg;case 36289:case 36303:case 36311:case 36292:return Eg}}class bg{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=sg(t.type)}}class Ag{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Tg(t.type)}}class wg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,a=i.length;r!==a;++r){const o=i[r];o.setValue(e,t[o.id],n)}}}const sa=/(\w+)(\])?(\[|\.)?/g;function Xc(s,e){s.seq.push(e),s.map[e.id]=e}function Rg(s,e,t){const n=s.name,i=n.length;for(sa.lastIndex=0;;){const r=sa.exec(n),a=sa.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===i){Xc(t,l===void 0?new bg(o,s,e):new Ag(o,s,e));break}else{let u=t.map[o];u===void 0&&(u=new wg(o),Xc(t,u)),t=u}}}class hr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),a=e.getUniformLocation(t,r.name);Rg(r,a,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const a=e[i];a.id in t&&n.push(a)}return n}}function Yc(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const Cg=37297;let Pg=0;function Lg(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=i;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const qc=new Ne;function Dg(s){Ge._getMatrix(qc,Ge.workingColorSpace,s);const e=`mat3( ${qc.elements.map(t=>t.toFixed(4))} )`;switch(Ge.getTransfer(s)){case dr:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function jc(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const a=parseInt(r[1]);return t.toUpperCase()+`

`+i+`

`+Lg(s.getShaderSource(e),a)}else return i}function Ig(s,e){const t=Dg(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Ug(s,e){let t;switch(e){case Ih:t="Linear";break;case Uh:t="Reinhard";break;case Nh:t="Cineon";break;case gl:t="ACESFilmic";break;case Oh:t="AgX";break;case Bh:t="Neutral";break;case Fh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const tr=new D;function Ng(){Ge.getLuminanceCoefficients(tr);const s=tr.x.toFixed(4),e=tr.y.toFixed(4),t=tr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}function Wg(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===fl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===pl?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Tn&&(e="SHADOWMAP_TYPE_VSM"),e}function Xg(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Bi:case ki:e="ENVMAP_TYPE_CUBE";break;case _r:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Yg(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case ki:e="ENVMAP_MODE_REFRACTION";break}return e}function qg(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case ml:e="ENVMAP_BLENDING_MULTIPLY";break;case Lh:e="ENVMAP_BLENDING_MIX";break;case Dh:e="ENVMAP_BLENDING_ADD";break}return e}function jg(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Kg(s,e,t,n){const i=s.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Wg(t),l=Xg(t),h=Yg(t),u=qg(t),d=jg(t),p=Fg(t),g=Og(r),x=i.createProgram();let m,f,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const E=b+m+a,S=b+f+o,I=Yc(i,i.VERTEX_SHADER,E),L=Yc(i,i.FRAGMENT_SHADER,S);i.attachShader(x,I),i.attachShader(x,L),t.index0AttributeName!==void 0?i.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(x,0,"position"),i.linkProgram(x);function A(w){if(s.debug.checkShaderErrors){const V=i.getProgramInfoLog(x).trim(),F=i.getShaderInfoLog(I).trim(),z=i.getShaderInfoLog(L).trim();let X=!0,H=!0;if(i.getProgramParameter(x,i.LINK_STATUS)===!1)if(X=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,x,I,L);else{const K=jc(i,I,"vertex"),G=jc(i,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(x,i.VALIDATE_STATUS)+`
...
`;continue}if((H=X.match(v))&&(z.gamma=parseFloat(H[1])),(H=X.match(w))&&(z.exposure=parseFloat(H[1])),(H=X.match(V))&&(z.valid|=2,z.format=H[1]),(H=X.match(F))&&(z.valid|=4,z.height=parseInt(H[1],10),z.width=parseInt(H[2],10)),z.valid&2&&z.valid&4)break}return z.valid&2||a(3,"missing format specifier"),z.valid&4||a(3,"missing image size specifier"),z},p=function(R,y,v){const w=y;if(w<8||w>32767||R[0]!==2||R[1]!==2||R[2]&128)return new Uint8Array(R);w!==(R[2]<<8|R[3])&&a(3,"wrong scanline width");const V=new Uint8Array(4*y*v);V.length||a(4,"unable to allocate buffer space");let F=0,z=0;const X=4*w,H=new Uint8Array(4),K=new Uint8Array(X);let G=v;for(;G>0&&z<R.byteLength;){z+4>R.byteLength&&a(1),H[0]=R[z++],H[1]=R[z++],H[2]=R[z++],H[3]=R[z++],(H[0]!=2||H[1]!=2||(H[2]<<8|H[3])!=w)&&a(3,"bad rgbe scanline format");let ne=0,re;for(;ne<X&&z<R.byteLength;){re=R[z++];const we=re>128;if(we&&(re-=128),(re===0||ne+re>X)&&a(3,"bad scanline data"),we){const ze=R[z++];for(let Y=0;Y<re;Y++)K[ne++]=ze}else K.set(R.subarray(z,z+re),ne),ne+=re,z+=re}const ve=w;for(let we=0;we<ve;we++){let ze=0;V[F]=K[we+ze],ze+=w,V[F+1]=K[we+ze],ze+=w,V[F+2]=K[we+ze],ze+=w,V[F+3]=K[we+ze],F+=4}G--}return V},g=function(R,y,v,w){const V=R[y+3],F=Math.pow(2,V-128)/255;v[w+0]=R[y+0]*F,v[w+1]=R[y+1]*F,v[w+2]=R[y+2]*F,v[w+3]=1},x=function(R,y,v,w){const V=R[y+3],F=Math.pow(2,V-128)/255;v[w+0]=Fs.toHalfFloat(Math.min(R[y+0]*F,65504)),v[w+1]=Fs.toHalfFloat(Math.min(R[y+1]*F,65504)),v[w+2]=Fs.toHalfFloat(Math.min(R[y+2]*F,65504)),v[w+3]=Fs.toHalfFloat(1)},m=new Uint8Array(e);m.pos=0;const f=d(m),b=f.width,E=f.height,S=p(m.subarray(m.pos),b,E);let I,L,A;switch(this.type){case Nt:A=S.length/4;const R=new Float32Array(A*4);for(let v=0;v<A;v++)g(S,v*4,R,v*4);I=R,L=Nt;break;case wn:A=S.length/4;const y=new Uint16Array(A*4);for(let v=0;v<A;v++)x(S,v*4,y,v*4);I=y,L=wn;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:b,height:E,data:I,header:f.string,gamma:f.gamma,exposure:f.exposure,type:L}}setDataType(e){return this.type=e,this}load(e,t,n,i){function r(a,o){switch(a.type){case Nt:case wn:a.colorSpace=bt,a.minFilter=St,a.magFilter=St,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,i)}}const ll=document.getElementById("app");ll&&(ll.innerHTML="");const Ql=document.createElement("canvas");document.body.appendChild(Ql);const M0=new D(0,8,15),y0=new D(0,2,0),gn=new E_({canvas:Ql,antialias:!0});gn.setSize(window.innerWidth,window.innerHeight);gn.setClearColor(13391138,.1);gn.toneMapping=gl;gn.toneMappingExposure=1.2;gn.outputColorSpace=yt;gn.shadowMap.enabled=!0;gn.shadowMap.type=pl;const Qt=new Xu,S0=new v0;S0.load("./MR_INT-001_NaturalStudio_NAD.hdr",function(s){s.mapping=fs,Qt.environment=s,Qt.background=s,console.log("HDR Mars environment loaded successfully ✅")},void 0,function(s){console.warn("HDR file not found, using fallback Mars sky");const e=document.createElement("canvas");e.width=512,e.height=256;const t=e.getContext("2d"),n=t.createLinearGradient(0,0,0,256);n.addColorStop(0,"#dc7f33ff"),n.addColorStop(.3,"#cc6633"),n.addColorStop(.7,"#ab321fff"),n.addColorStop(1,"#2d1810"),t.fillStyle=n,t.fillRect(0,0,512,256);const i=new sd(e);i.mapping=fs,Qt.background=i,Qt.environment=i});const hi=new Pt(60,window.innerWidth/window.innerHeight,.1,1e3);hi.position.set(0,5,10);const nn=new bo(16755302,1.8);nn.position.set(20,30,15);nn.castShadow=!0;nn.shadow.mapSize.width=2048;nn.shadow.mapSize.height=2048;nn.shadow.camera.near=.5;nn.shadow.camera.far=100;nn.shadow.camera.left=-50;nn.shadow.camera.right=50;nn.shadow.camera.top=50;nn.shadow.camera.bottom=-50;Qt.add(nn);const E0=new wd(6702131,.3);Qt.add(E0);const eh=new bo(16737843,.5);eh.position.set(-20,10,-15);Qt.add(eh);const Ki=new Ft(new Es(200,200,50,50),new xr({color:16311472,transparent:!0,opacity:.3,roughness:.9,metalness:.02,bumpScale:.1,depthWrite:!1}));Ki.rotation.x=-Math.PI/2;Ki.receiveShadow=!0;const hl=Ki.geometry.attributes.position.array;for(let s=0;s<hl.length;s+=3)hl[s+2]+=Math.random()*.5-.25;Ki.geometry.attributes.position.needsUpdate=!0;Ki.geometry.computeVertexNormals();Qt.add(Ki);const ut=new a0(hi,gn.domElement);ut.enableDamping=!0;ut.dampingFactor=.05;ut.enableZoom=!0;ut.enablePan=!0;ut.screenSpacePanning=!1;ut.minDistance=.5;ut.maxDistance=100;ut.minPolarAngle=0;ut.maxPolarAngle=Math.PI;ut.maxPolarAngle=Math.PI;ut.minAzimuthAngle=-1/0;ut.maxAzimuthAngle=1/0;const Ye={w:!1,a:!1,s:!1,d:!1,shift:!1,space:!1},ul=.1;document.addEventListener("keydown",s=>{switch(s.code){case"KeyW":Ye.w=!0;break;case"KeyA":Ye.a=!0;break;case"KeyS":Ye.s=!0;break;case"KeyD":Ye.d=!0;break;case"ShiftLeft":Ye.shift=!0;break;case"Space":Ye.space=!0,s.preventDefault();break}});document.addEventListener("keyup",s=>{switch(s.code){case"KeyW":Ye.w=!1;break;case"KeyA":Ye.a=!1;break;case"KeyS":Ye.s=!1;break;case"KeyD":Ye.d=!1;break;case"ShiftLeft":Ye.shift=!1;break;case"Space":Ye.space=!1;break}});function T0(){const s=Ye.shift?ul*3:ul;Ye.w&&ut.object.translateZ(-s),Ye.s&&ut.object.translateZ(s),Ye.a&&ut.object.translateX(-s),Ye.d&&ut.object.translateX(s),Ye.space&&ut.object.translateY(s)}let sn=null,gr="base";const b0={base:{path:"./models/mars_one_mission_base/scene.gltf",name:"Mission Base"}},A0=new T_;async function w0(s){return console.log(`Loading: ${s}`),new Promise((e,t)=>{A0.load(s,n=>{console.log(`Loaded successfully: ${s}`),n.scene.traverse(i=>{i.isMesh&&(i.castShadow=!0,i.receiveShadow=!0)}),e(n.scene)},void 0,n=>{console.error(`❌ Error loading ${s}:`,n),t(n)})})}async function th(s){sn&&(Qt.remove(sn),sn.traverse(e=>{e.isMesh&&(e.geometry.dispose(),e.material.map&&e.material.map.dispose(),e.material.dispose())}),sn=null),hi.position.copy(M0),ut.target.copy(y0),ut.update();try{sn=await w0(b0[s].path),sn.position.set(0,0,0),sn.scale.set(2,2,2),Qt.add(sn),ut.reset(),hi.position.set(0,8,15),ut.target.set(0,2,0),ut.update()}catch(e){console.error("Model loading error:",e)}}function R0(){const s=document.createElement("div");s.id="mars-hud",s.style.cssText=`
    position: fixed;
    top: 0;
    left: 0;
    right: 0;
  ...
  `,e.onmouseover=()=>e.style.background="rgba(255, 255, 255, 0.2)",e.onmouseout=()=>e.style.background="rgba(255, 255, 255, 0.1)",e.onclick=()=>{window.history.back()};const t=localStorage.getItem("playerName")||"Space Explorer",n=document.createElement("div");n.style.cssText=`
...
`,a.onmouseover=()=>{a.style.background="rgba(255, 255, 255, 0.2)"},a.onmouseout=()=>{a.style.background="rgba(255, 255, 255, 0.1)"},a.onclick=()=>{r&&(r.paused?(r.play().catch(o=>console.warn("Audio playback failed:",o)),a.innerHTML='<i class="fas fa-volume-up"></i>'):(r.pause(),a.innerHTML='<i class="fas fa-volume-mute"></i>'))},s.appendChild(e),s.appendChild(n),s.appendChild(i),s.appendChild(a),document.body.appendChild(s),window.addEventListener("resize",()=>{window.innerWidth<=600?(s.style.height="auto",i.innerHTML="WASD: Move | Touch: Look"):(s.style.height="60px",i.innerHTML="WASD: Move | Mouse: Look<br>Shift: Speed | Space: Up")})}function C0(){const s=document.createElement("link");s.rel="stylesheet",s.href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css",document.head.appendChild(s);const e=document.createElement("div");e.className="navbar",e.style.cssText=`
  ...
  `,s.appendChild(e),document.body.appendChild(s),(window.innerWidth<=768||"ontouchstart"in window)&&(s.style.display="block");let t=!1,n,i;s.addEventListener("touchstart",r=>{r.preventDefault(),t=!0;const a=s.getBoundingClientRect();n=a.left+a.width/2,i=a.top+a.height/2}),s.addEventListener("touchmove",r=>{if(!t)return;const a=r.touches[0];let o=a.clientX-n,c=a.clientY-i;const l=Math.sqrt(o*o+c*c),h=50;l>h&&(o=o/l*h,c=c/l*h),e.style.transform=`translate(${o-25}px, ${c-25}px)`,Ye.w=c<-20,Ye.s=c>20,Ye.a=o<-20,Ye.d=o>20,Ye.shift=l>40}),s.addEventListener("touchend",()=>{t=!1,e.style.transform="translate(-50%, -50%)",Ye.w=!1,Ye.s=!1,Ye.a=!1,Ye.d=!1,Ye.shift=!1})}P0();let la=!1;function L0(){la=!la,la?(D0(),gr="weather"):nh()}async function D0(){if(document.getElementById("weather-container"))return;const t="https://corsproxy.io/?https://api.nasa.gov/insight_weather/?api_key=DEMO_KEY&feedtype=json&ver=1.0";try{const i=await(await fetch(t)).json(),r=i.sol_keys||[],a=document.createElement("div");a.id="weather-container",a.style=`
    ...
    `,a.innerHTML='<h2><i class="fas fa-thermometer-half"></i> Mars Weather Insights</h2>',r.forEach(o=>{const c=i[o];a.innerHTML+=`
      ...
      border: 1px solid rgba(255, 255, 255, 0.3);
      backdrop-filter: blur(10px);
    `,a.innerHTML='<h2><i class="fas fa-camera"></i> Mars Rover Gallery</h2>',r.forEach(o=>{const c=document.createElement("img");c.src=o.img_src,c.alt="Mars Rover",c.style="width: 100%; border-radius: 4px; cursor: pointer; margin-bottom: 0.5rem;",c.addEventListener("click",()=>N0(o.img_src,o.earth_date,o.camera.full_name)),a.appendChild(c)}),document.body.appendChild(a)}catch(n){console.error("Gallery fetch failed:",n),container.innerHTML=`
    ...
    `,document.body.appendChild(container)}}function ih(){const s=document.getElementById("gallery-container");s&&s.remove(),eo()}function N0(s,e,t){eo();const n=document.createElement("div");n.id="image-modal",n.style=`
    position: fixed;
    top: 0;
    left: 0;
    width: 100vw;
  ...
  `;const i=document.createElement("div");i.textContent="✖",i.style=`
    ...
    color: white;
    cursor: pointer;
  `,i.addEventListener("click",eo);const r=document.createElement("img");r.src=s,r.style=`
    max-width: 90%;
    max-height: 80vh;
    border-radius: 12px;
    box-shadow: 0 0 15px rgba(255,255,255,0.3);
  `;const a=document.createElement("div");a.textContent=`📅 ${e} | 📷 ${t}`,a.style="color: white; margin-top: 1rem; font-size: 1rem;",n.appendChild(i),n.appendChild(r),n.appendChild(a),document.body.appendChild(n)}function eo(){const s=document.getElementById("image-modal");s&&s.remove()}function F0(){nh(),ih();let s=document.getElementById("map-placeholder");s&&s.remove();const e=document.createElement("div");e.id="map-placeholder",e.style.cssText=`
    position: fixed;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
  ...
  `,document.body.appendChild(e)}function O0(){const s=document.getElementById("map-placeholder");s&&s.remove()}const Zi=document.createElement("div");Zi.id="mars360Modal";Zi.style.cssText=`
  display: none;
  position: fixed;
  top: 0; left: 0;
...
`;const Dn=document.createElement("video");Dn.controls=!1;Dn.loop=!0;Dn.muted=!0;Dn.setAttribute("playsinline","");Dn.style.cssText=`
  width: 100%;
  height: 100%;
  object-fit: cover;
`;const yr=document.createElement("button");yr.innerHTML='<i class="fas fa-times"></i>';yr.style.cssText=`
  position: absolute;
  top: 20px;
  right: 20px;
  padding: 10px 15px;
  ...
  cursor: pointer;
  pointer-events: auto;
`;yr.onclick=()=>B0();bs.appendChild(Dn);Un.appendChild(bs);Zi.appendChild(Un);Zi.appendChild(yr);document.body.appendChild(Zi);let Po=!1,to=0,no=0,io=1;function B0(s){Zi.style.display="none",Dn.pause(),Dn.src="",Dn.style.background=""}function dl(){bs.style.transform=`translate(${-to}px, ${-no}px) scale(${io})`,Un.style.left=`calc(50% + ${to}px)`,Un.style.top=`calc(50% + ${no}px)`}let so,ro,ds=0;Un.addEventListener("touchstart",s=>{if(s.preventDefault(),s.touches.length===1)Po=!0,so=s.touches[0].clientX,ro=s.touches[0].clientY;else if(s.touches.length===2){const e=s.touches[0].clientX-s.touches[1].clientX,t=s.touches[0].clientY-s.touches[1].clientY;ds=Math.sqrt(e*e+t*t)}});Un.addEventListener("touchmove",s=>{if(s.touches.length===1&&Po){const e=s.touches[0].clientX,t=s.touches[0].clientY;to+=(so-e)*.5,no+=(ro-t)*.5,so=e,ro=t,dl()}else if(s.touches.length===2){const e=s.touches[0].clientX-s.touches[1].clientX,t=s.touches[0].clientY-s.touches[1].clientY,n=Math.sqrt(e*e+t*t);if(ds>0){const i=n/ds;io=Math.max(.5,Math.min(io*i,3)),ds=n,dl()}}});Un.addEventListener("touchend",()=>{Po=!1,ds=0});function sh(){requestAnimationFrame(sh),T0(),sn&&!Ye.w&&!Ye.a&&!Ye.s&&!Ye.d&&(sn.rotation.y+=.002),ut.update(),gn.render(Qt,hi)}window.addEventListener("resize",()=>{hi.aspect=window.innerWidth/window.innerHeight,hi.updateProjectionMatrix(),gn.setSize(window.innerWidth,window.innerHeight)});R0();C0();th("base");const ir=document.getElementById("marsTheme");ir?(ir.loop=!0,ir.volume=.5,ir.play().catch(s=>{console.warn("Autoplay blocked. Please interact with the page to enable audio:",s)})):console.warn("Audio element with id 'marsTheme' not found in the DOM.");sh();console.log("Mars Viewer initialized! 🚀");console.log("Controls: WASD to move, mouse to look around, Shift for speed boost");
